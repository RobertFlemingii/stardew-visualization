...
function Foraging() {
  ...
  const chartData = {
    labels: filteredData.map((entry) => entry.forage), // Ensure "Name" matches CSV header exactly
    datasets: [
      {
  ...
  return (
    <div className="chart-container" style={{ height: "400px", width: "100%" }}>
      <h2 style={{ color: "white" }}>Foraging Data - {selectedMetric}</h2>
      <select
